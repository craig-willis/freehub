...
EOF
      ...
      if (@service.send_email?) 
         ...
         smtp.start('gmail.com', from, APP_CONFIG['email_password'], :login)
         smtp.send_message(content, from, to)
      end

      #subscribees = @person.email
      #https://lists.chambana.net/mailman/listinfo/bikecoop-announce
      #"http://lists.chambana.net/mailman/admin/bikecoop-announce/members/add?subscribees=[user_email_address]&adminpw=#{adminpw}&send_welcome_msg_to_this_batch=1&send_notifications_to_list_owner=0
